Implementations of string processing algorithms and data structures, mostly from the books *Algorithms on Strings, Trees, and Sequences* and *Genome-Scale Algorithm Design*.
